...
export const quiz_list: IQuiz[] = [
      ...
      contents: [
        {
          ...
          text: 'หลายครั้งบทสนทนาระหว่างบุคคลที่มีอายุต่างกัน ( เช่น เด็ก กับ ผู้ใหญ่) อาจมีความคิดเห็นที่ไม่ตรงกัน <span>ผู้ใหญ่หรือพ่อแม่หลายคน อาจจะมีความเข้าใจว่าความคิด ความเชื่อของตนเองเป็นสิ่งที่ถูกต้องและมีประสบการณ์มามากกว่า</span>'
        },
        {
          image_url: '/part_3/quiz_02/illus_event.02.02.png',
          text: '<span></span>ส่วนเด็กหรือคนที่อายุน้อยกว่า อาจจะเชื่อในสิ่งที่รับรู้ เห็นหรือหาข้อมูลด้วยตัวเอง</span>\n\nเช่น ในเรื่องการเรียน อาชีพ ก่อให้เกิดความคิดเห็นที่ไม่ตรงกัน และต่างฝ่ายต่างมีเหตุผลของตนเอง'
        }
      ],
      ...
      contents: [
        {
          ...
          text: 'แต่มีกรณีที่การรวมกลุ่มของบางกลุ่มที่ออกมาสนับสนุนการชุมนุมม็อบและประณามรัฐบาลเรื่องสิทธิมนุษยชนมักถูกกล่าวอ้างว่า “รับเงินต่างชาติ”<span>ทำให้รัฐพิจารณาต่อไปให้มีร่างกฎหมายจะมาควบคุมกำกับดูแล การรวมกลุ่มมากขึ้น</span>'
        },
        {
          image_url: '/part_3/quiz_03/illus_event.03.02.png',
          text: 'และคณะรัฐมนตรีเองอนุมัติหลักการ<span>ร่างกฎหมายเกี่ยวกับการตั้งองค์กร NGO มากำกับดูแลการจดทะเบียนหรือการเข้ามาจัดการเรื่องการรวมกลุ่ม</span>เพิ่มขึ้นอีกด้วย โดยเฉพาะการชี้แจงรายได้ '
        }
      ],
      question: 'คิดว่านักเรียนควรมีเสรีภาพในทรงผมของตัวหรือไม่?\nในสังคมควรทำอย่างไรต่อไป?'
    },
      ...
      contents: [
        {
          ...
          text: '<span>ฝั่งที่เห็นว่าควรแต่งกายชุดนักเรียนเป็นการแสดงออกในสถานะความเป็นนักเรียน</span> มองการใส่ชุดไปรเวทเป็นเรื่องแฟชั่นซึ่งจะสร้างความแตกต่างเหลื่อมล้ำได้ง่าย'
        },
        {
          image_url: '/part_3/quiz_04/illus_event.04.02.png',
          text: '<span>ฝั่งที่เห็นว่าควรแต่งชุดไปรเวทเป็นการฝึกการแต่งตัวและเสริมสร้างความมั่นใจของเด็ก</span>เพิ่มความสุขและช่วยสร้างสังคมที่เคารพความแตกต่างได้\n\nแต่บางกรณีการแต่งชุดไปรเวทกลับถูกเลือกปฏิบัติ เช่น การเรียกไปคุยเพื่อให้เปลี่ยนชุด หรือถูกจดชื่อ เป็นต้น'
        },
        {
          image_url: '/part_3/quiz_04/illus_event.04.03.png',
          text: '<span>และมีอีกหลายฝั่งที่มีความเห็นเพิ่มเติมอีก เช่น นานๆ ทีได้ใส่ชุดไปรเวทในวันหยุด เสาร์-อาทิตย์ ก็เพียงพอแล้ว</span> หรือใน 1 อาทิตย์ก็มีหลายชุดให้ใส่ เช่น ชุดพละ ชุดเนตรนารี ก็มีความหลากหลายเพียงพอแล้วเช่นกัน'
        }
      ],
      question: 'คิดว่านักเรียนควรมีเสรีภาพในทรงผมของตัวหรือไม่?\nในสังคมควรทำอย่างไรต่อไป?'
    },
      ...
      contents: [
        {
          ...
          text: 'ทำให้เพศหลากหลายไม่สามารถใช้ห้องน้ำเหมาะสมกับเพศของตนอีกทั้งเวลาที่ใช้ห้องน้ำ <span>ทำให้เกิดความไม่สบายใจกันทั้งสองฝ่าย</span>'
        },
        {
          image_url: '/part_3/quiz_05/illus_event.05.02.png',
          text: 'ดังนั้น<span>ทำให้ฝ่ายนึงเห็นว่าควรสร้างห้องน้ำแบบไม่แบ่งแยกเพศ</span>โดยทุกคนสามารถเข้าได้\n\n<span>แต่อีกฝ่ายมองว่าการไม่แบ่งแยกเพศเลยจะสร้างความไม่ปลอดภัยเกิดขึ้นได้</span>'
        }
      ],
      question: 'คิดว่านักเรียนควรมีเสรีภาพในทรงผมของตัวหรือไม่?\nในสังคมควรทำอย่างไรต่อไป?'
    },
  ...
  },
  {
    ...
    event: {
      ...
      sub_title:
        'มีเหตุการณ์นักเรียนหลายโรงเรียนในหลายจังหวัดแสดงออกหรือนัดทำกิจกรรม เพื่อแสดงออกทางการเมืองเช่น โพสต์แสดงความคิดเห็น ร้องเพลง ชูสามนิ้ว และผูกโบขาว',
      contents: [
        {
          image_url: '/part_3/quiz_06/illus_event.06.01.png',
          text: 'บ่อยครั้งที่หลายคนก่อนออกจากบ้าน ลุกขึ้นมาอาบน้ำ เลือกชุดตัวโปรด มาแต่งตัว แต่งหน้า ส่องกระจกด้วยความมั่นใจ <span>จนกระทั่งเจอคำทักทาย เช่น “วันนี้แต่งตัว แต่งหน้าเต็มเชียว” ,“ทำไมกล้าแต่งตัวแบบนี้มา”</span>'
        },
        {
          image_url: '/part_3/quiz_06/illus_event.06.02.png',
          text: '<span>ทำให้ความมั่นใจที่สะสมมาพังทลายลง ความรู้สึกที่สดใสถูกแทนที่ด้วยความกังวล</span> แถมอดไม่ได้ที่จะเช็คตัวเองในกระจกตลอดทั้งวัน ซึ่งหลายคนเคยเจอเหตุการณ์เหล่านี้มา'
        }
      ],
      question: 'คิดว่านักเรียนควรมีเสรีภาพในทรงผมของตัวหรือไม่?\nในสังคมควรทำอย่างไรต่อไป?'
    },
      ...
      contents: [
        {
          ...
          text: 'แต่มีกรณีที่การแสดงออกไม่สามารถทำได้อิสระ <span>โดยบางคนถูกดึงโบขาวออกจากกระเป๋าไปผูกคอ บางคนถูกเรียกเข้าห้องปกครองกับการแสดงออก</span>'
        },
        {
          image_url: '/part_3/quiz_07/illus_event.07.02.png',
          text: '<span>ซึ่งในบางมุมมองของผู้ปกครองหรือครูบางกรณียังเป็นห่วงกับ การแสดงออกของนักเรียนในวัยเรียน</span> ที่อาจจะกระทบต่อการเรียนและในอนาคต หรืออาจเกิดความรุนแรงขึ้นได้ทำให้แสดงออกผ่านการห้ามปราม ตักเตือน'
        }
      ],
      question: 'คิดว่านักเรียนควรมีเสรีภาพในทรงผมของตัวหรือไม่?\nในสังคมควรทำอย่างไรต่อไป?'
    },
  ...
  },
  {
    ...
    event: {
      ...
      contents: [
        {
          image_url: '/part_3/quiz_01/illus_event.01.01.png',
          text: 'เช่น การยืนนิ่ง จัดกิจกรรมร้องเพลง เขียนข้อความ แม้แต่ปราศรัยและ<span>เชิญชวนใช้พื้นที่สถานศึกษาจัดการชุมนุมแสดงออก</span>'
        },
        {
          image_url: '/part_3/quiz_01/illus_event.01.02.png',
          text: 'ซึ่งบางสถานศึกษามองว่า <span>“สถานศึกษาควรเป็นพื้นที่ที่เป็นกลางทางการเมือง ไม่ควรเลือกข้างสร้างความขัดแย้งหรือก่อให้เกิดความไม่สงบ”</span>\n\nเลยออกประกาศไม่ให้จัดการชุมนุมในโรงเรียน นักเรียนต้องชุมนุมนอกรั้วหรือบางกรณีให้ตำรวจเข้ามาควบคุมดูแลในพื้นที่ชุมนุมแต่ไม่ให้ศิษย์เก่าหรือคนนอกเข้ามาชุมนุม'
        }
      ],
      question: 'คิดว่านักเรียนควรมีเสรีภาพในทรงผมของตัวหรือไม่?\nในสังคมควรทำอย่างไรต่อไป?'
    },
  ...
  },
  {
    ...
    event: {
      ...
      contents: [
        {
          image_url: '/part_3/quiz_01/illus_event.01.01.png',
          text: 'เป็นกิจกรรมที่มีอย่างยาวนาน โดยมีให้ทำพานไหว้ครู เพื่อมอบให้ครูแต่ก็มีประเด็นตั้งคำถามกันว่า <span>บางโรงเรียนให้เด็กยืนตากแดดนั่งเป็นเวลานานเกินไป หรือยังมีวัฒนธรรมที่ต้องมอบคลานให้นำพานไปไหว้ครู</span>'
        },
        {
          image_url: '/part_3/quiz_01/illus_event.01.02.png',
          text: 'จนนักเรียนบางคนก็ไม่เห็นด้วย <span>ออกมาแสดงความคิดเห็น หรือแม้แต่โพสต์ข้อความบางคนถึงกับไม่เข้าร่วมกิจกรรมนี้</span>'
        }
      ],
      question: 'คิดว่านักเรียนควรมีเสรีภาพในทรงผมของตัวหรือไม่?\nในสังคมควรทำอย่างไรต่อไป?'
    },
